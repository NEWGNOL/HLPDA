			...
			<view class="uni-list-item__container"
				...
				<slot name="body">
					<view class="uni-list-item__content"
						...
						{{ note }}</text>						
						<!-- <button class="detail" v-on:click="buttonclick('明细')" v-show="isshowbutton">明细</button> -->
						<button class="fillmanhour" v-on:click="buttonclick('工时')" v-show="isshowbutton">工时</button>
